...
function AdminRegistration() {
    const { AdminRegistration } = useContext(Authcontext);
    // ...............................
                            ...
                            <form onSubmit={Onhandleform} method="post">
                                <div className="row g-3">
                                    ...
                                    <div className="col-12">
                                        <button className="btn btn-primary rounded-pill py-3 px-5" type="submit">Register</button>
                                    </div>
                                </div>
                            </form>
                        </div>
